          ...
          <div class="col-xl-12 col-md-12">
            <div class="ms-panel">
              ...
              <div class="ms-panel-body">
                <form class="needs-validation" action="{{ route('update_expense') }}" method="POST" enctype="multipart/form-data"  novalidate>
                  @csrf
                  ...
                  <div class="form-row">
                    <div class="col-md-12 mb-3">
                      <label for="validationCustom01">Expense Description</label>
                      <div class="input-group">
