        ...
        <div class="col-md-12">
          ...
          <div class="ms-panel">
            <div class="ms-panel-header">
              <button type="button" onclick="location.href='add_category_ui'"  class="btn btn-primary" style="float: right">Add category</button>
              <h6>Customer List</h6>
                    ...
                    <thead>
                        ...
                        <tbody>
                          ...
                          <?php
                            ...
                            <td><a href="edit_category_ui/{{ $data->id }}"><i class="fa fa-edit"></i></a><span><a  href="javascript:void(0);" onclick="delete_data({{ $data->id }})"><i class="fa fa-trash"></i></a></span> </td>
                            </tr>
                            @endforeach
                        </tbody>
                    </thead>
